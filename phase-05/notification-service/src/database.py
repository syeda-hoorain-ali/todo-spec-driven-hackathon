"""Database module for Notification Service."""
import logging
...
class DatabaseManager:
    """Manages database connections and operations for the notification service."""
    ...
    async def ensure_db_tables(self):
        ...
        async with self.pool.acquire() as conn:
            ...
            try:
                ...
                await conn.fetchval("SELECT to_regclass('public.notification')")

                # Check if notification_channel_preferences table exists
                await conn.fetchval("SELECT to_regclass('public.notification_channel_preferences')")
