...
class DatabaseManager:
    """Manages database connections and operations for the audit service."""
    ...
    async def ensure_db_tables(self):
        ...
        async with self.pool.acquire() as conn:
            ...
            try:
                ...
                await conn.fetchval("SELECT to_regclass('public.audit_log')")

                # Check if dead_letter_queue table exists
                await conn.fetchval("SELECT to_regclass('public.dead_letter_queue')")
