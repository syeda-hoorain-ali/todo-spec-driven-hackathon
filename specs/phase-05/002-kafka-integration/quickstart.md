...
KAFKA_CLIENT_ID=todo-chatbot
KAFKA_GROUP_ID=todo-group
...
docker exec -it kafka-local kafka-consumer-groups --bootstrap-server localhost:9092 --describe --group todo-group
```
